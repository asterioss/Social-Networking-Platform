...
function comment(id) {
	...
	var id = id;
    var data = 'username=' + logged_user + '&com=' + com + '&id=' + id;
...
function rating(id) {
	...
	var id = id;
    var data = 'username=' + logged_user + '&rate=' + rate + '&id=' + id;
...
function popup(id) {
    var data = 'username=' +logged_user+ '&id=' + id;
